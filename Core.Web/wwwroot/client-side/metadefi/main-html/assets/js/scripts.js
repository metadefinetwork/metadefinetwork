...
NioApp = function (NioApp, $, window, document) {
	...
	NioApp.Plugins.particles = function () {
        ...
        //var $particles_bg1 = $('.particles-bg-1');
        //if ($particles_bg1.exists()) {
        //    $particles_bg1.each(function () {
        //        var $self = $(this), $self_id = $self.attr('id'),
        //            _pt_base = ($self.data('pt-base')) ? $self.data('pt-base') : '#fff',
        //            _pt_base_op = ($self.data('pt-base-op')) ? parseFloat($self.data('pt-base-op')) : 0.10,
        //            _pt_shape = ($self.data('pt-shape')) ? $self.data('pt-shape') : '#fff',
        ...
        //var $particles_bg2 = $('.particles-bg-2');
        //if ($particles_bg2.exists()) {
        //    $particles_bg2.each(function () {
        //        var $self = $(this), $self_id = $self.attr('id'),
        //            _pt_base = ($self.data('pt-base')) ? $self.data('pt-base') : '#fff',
        //            _pt_base_op = ($self.data('pt-base-op')) ? parseFloat($self.data('pt-base-op')) : 0.10,
        //            _pt_shape = ($self.data('pt-shape')) ? $self.data('pt-shape') : '#fff',
        ...
        //var $particles_bg3 = $('.particles-bg-3');
        //if ($particles_bg3.exists()) {
        //    $particles_bg3.each(function () {
        //        var $self = $(this), $self_id = $self.attr('id'),
        //            _pt_base = ($self.data('pt-base')) ? $self.data('pt-base') : '#fff',
        //            _pt_base_op = ($self.data('pt-base-op')) ? parseFloat($self.data('pt-base-op')) : 0.10,
        //            _pt_shape = ($self.data('pt-shape')) ? $self.data('pt-shape') : '#fff',
        ...
        //var $particles_bg4 = $('.particles-bg-4');
        //if ($particles_bg4.exists()) {
        //    $particles_bg4.each(function () {
        //        var $self = $(this), $self_id = $self.attr('id'),
        //            _pt_base = ($self.data('pt-base')) ? $self.data('pt-base') : '#fff',
        //            _pt_base_op = ($self.data('pt-base-op')) ? parseFloat($self.data('pt-base-op')) : 0.10,
        //            _pt_shape = ($self.data('pt-shape')) ? $self.data('pt-shape') : '#fff',
