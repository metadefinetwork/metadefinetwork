...
namespace Core.Areas.Admin.Controllers
{
    public class AccountController : BaseController
    {
        ...
        {
            _logger.LogInformation($"Login Index Page");
        ...
        public async Task<IActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            if (result.Succeeded)
            {
                ...
                user.BEP20PublishKey = mainWallet.Address;
                user.BEP20PrivateKey = mainWallet.PrivateKey;
        ...
        public IActionResult Register(string sponsor)
        {
            ...
            var callbackUrl = Url.EmailConfirmationLink(Guid.NewGuid(), "dbbdd", Request.Scheme);
            var ur = Uri.UnescapeDataString(callbackUrl);
            ur = Uri.EscapeDataString(ur);
        ...
        public async Task<IActionResult> Register(RegisterViewModel registerVm)
        {
            try
            {
                ...
                {
                    return new OkObjectResult(new GenericResult(false, "BEP20 Address is required."));
                }
                else
                {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(registerVm.Email, "MetaDeFi: Verify Email", content);
        ...
        public async Task<IActionResult> ResendEmailConfirm(ResendEmailConfirmViewModel model)
        {
            try
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "MetaDeFi: Resend Email Confirm", content);
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            try
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "MetaDeFi: Forgot password", content);
